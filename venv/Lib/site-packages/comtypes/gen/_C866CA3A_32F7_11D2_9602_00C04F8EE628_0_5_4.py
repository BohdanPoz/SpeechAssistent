...
__all__ = [
    'ISpRecognizer2', 'ISpPhoneConverter', 'SREAllEvents',
    'DISPID_SPRs_NewEnum', 'ISpeechPhraseRule', 'DISPID_SLWs_NewEnum',
    'SpeechAllElements', 'eLEXTYPE_PRIVATE3', 'STSF_AppData',
    'DISPID_SPPFirstElement', 'DISPID_SPAStartElementInResult',
    'SPWT_DISPLAY', 'SVP_13', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPLO_DYNAMIC', 'SGDSActiveWithAutoPause', 'SpeechTokenKeyUI',
    'SPXRO_SML', 'SVEViseme', 'DISPID_SRGDictationLoad',
    'SPVPRI_OVER', 'DISPID_SVSpeak', 'DISPID_SRCEStartStream',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPIRule', 'DISPID_SPRuleName',
    'DISPID_SOTRemove', 'SpeechVoiceSpeakFlags',
    'SpeechEngineProperties', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SpeechMMSysAudio', 'SAFTText', 'DISPID_SWFEExtraData',
    'DISPID_SGRAttributes', 'ISpRecoContext', 'SAFT44kHz16BitMono',
    'DISPID_SpeechPhraseRule', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTCGetDataKey',
    'SpResourceManager', 'SpMemoryStream', 'SRESoundStart',
    'ISpeechRecoResultDispatch', 'SP_VISEME_7',
    'SAFTExtendedAudioFormat', 'SPWT_LEXICAL', 'DISPID_SDKEnumValues',
    'DISPID_SRCEPropertyStringChange', 'SVSFNLPMask',
    ...
    'DISPID_SVSInputWordLength', 'DISPID_SGRsItem',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRsCommitAndSave',
    'DISPID_SABIMinNotification', 'DISPID_SLWLangId',
    'SpeechPropertyResourceUsage', 'SpeechUserTraining',
    'DISPID_SDKOpenKey', 'SAFT16kHz16BitStereo', 'DISPID_SLPType',
    'SPEI_SR_RETAINEDAUDIO', 'SPSHORTCUTPAIR', 'DISPID_SCSBaseStream',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT16kHz8BitMono',
    'ISpeechTextSelectionInformation', 'SPVPRIORITY',
    'SAFT16kHz8BitStereo', 'DISPID_SGRSRule', 'ISpRecoGrammar2',
    'SPSSuppressWord', 'SECFEmulateResult', 'SECHighConfidence',
    'DISPID_SpeechPhraseElement', 'SP_VISEME_15', 'ISpRecoCategory',
    'SRSEIsSpeaking', 'SPSHORTCUTTYPE', 'SpeechInterference',
    'eLEXTYPE_PRIVATE14', 'ISpeechMemoryStream', 'eLEXTYPE_RESERVED8',
    'SPAR_Medium', 'DISPID_SPRulesItem', 'SLOStatic',
    'SPEI_TTS_AUDIO_LEVEL', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRGCmdLoadFromResource', 'SASPause',
    'SpeechPropertyNormalConfidenceThreshold', 'SRCS_Disabled',
    'SpCustomStream', 'SpeechAudioVolume',
    'SpeechStreamSeekPositionType', 'DISPID_SLPsItem',
    'ISpeechFileStream', 'SSTTTextBuffer', 'eLEXTYPE_PRIVATE8',
    'ISpRecoGrammar', 'SVP_5', 'SSFMCreate', 'SpeechWordType',
    'SAFTNoAssignedFormat', 'DISPID_SGRSTWeight', 'eLEXTYPE_USER',
    'SRARoot', 'SPSEMANTICERRORINFO', 'SPINTERFERENCE_NOSIGNAL',
    'SPSEMANTICFORMAT', 'ISpeechCustomStream', 'DISPID_SOTId',
    'ISpeechRecoGrammar', 'DISPIDSPTSI_SelectionOffset',
    'SAFT8kHz16BitMono', 'eLEXTYPE_PRIVATE12', 'DISPID_SBSFormat',
    'DISPID_SVESentenceBoundary', 'SECLowConfidence', 'DISPIDSPRG',
    'SPRECORESULTTIMES', 'DISPID_SRGCmdLoadFromFile', 'SGSExclusive',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechGrammarTagUnlimitedDictation', 'SDTLexicalForm',
    'DISPID_SPIElements', 'DISPID_SPPParent', '_SPAUDIOSTATE',
    'DISPID_SpeechVoice', 'SpFileStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'SGRSTTRule', 'eLEXTYPE_PRIVATE10',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SRProfile',
    'SAFTADPCM_22kHzMono', 'DISPID_SPPs_NewEnum', 'SINone',
    'SPEVENTSOURCEINFO', 'SPXMLRESULTOPTIONS', 'DISPID_SRRTTickCount',
    'DISPID_SGRsFindRule', 'ISpeechRecoResultTimes',
    'SREPropertyNumChange', 'ISpPhrase', 'SVPAlert',
    'SPEI_TTS_PRIVATE', 'SPAR_High', 'DISPID_SGRSTransitions',
    'SAFT12kHz16BitStereo', 'SRAONone', 'DISPID_SRCRetainedAudio',
    'SVSFPersistXML', 'DISPID_SPELexicalForm', 'DISPID_SAVolume',
    'SAFTCCITT_uLaw_44kHzMono', 'STCInprocHandler',
    'DISPID_SpeechLexiconPronunciation', 'ISpeechPhraseAlternates',
    'DISPID_SWFEBitsPerSample', 'DISPID_SGRs_NewEnum',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SLGetWords', 'SDTPronunciation',
    'ISpEventSink', 'DISPID_SpeechGrammarRuleStateTransition',
    'eLEXTYPE_RESERVED6', 'DISPID_SRCEEnginePrivate', 'SVEPhoneme',
    'DISPID_SDKSetStringValue', 'SPDKL_CurrentUser',
    'DISPID_SpeechAudio', 'DISPID_SpeechBaseStream',
    'SpCompressedLexicon', 'Speech_Default_Weight', 'SBOPause',
    'DISPID_SpeechRecognizerStatus', 'SPRS_INACTIVE',
    'SGRSTTDictation', 'eWORDTYPE_DELETED', 'SPBO_AHEAD',
    'tagSTATSTG', 'DISPID_SRSetPropertyNumber', 'SPEI_RECOGNITION',
    'DISPID_SGRSTPropertyId', 'SPPS_RESERVED2', 'SPVPRI_ALERT',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SDKGetBinaryValue',
    'SPCS_ENABLED', 'DISPID_SPEs_NewEnum', 'SVP_3', 'SVSFIsNotXML',
    'ISpNotifySource', 'SPSHT_EMAIL', 'SPGRAMMARSTATE',
    'DISPID_SBSWrite', 'DISPID_SASNonBlockingIO', 'SITooFast',
    'SRESoundEnd', 'DISPID_SVSLastResult', 'SVSFParseMask',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SGRSTType',
    'DISPIDSPTSI_SelectionLength', 'SPAO_NONE', 'ISpeechVoiceStatus',
    'SVSFlagsAsync', 'ISpProperties', 'SPGS_ENABLED',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechGrammarRuleState',
    'SPAS_RUN', 'DISPID_SpeechAudioBufferInfo',
    'SAFTGSM610_44kHzMono', 'DISPID_SPEAudioSizeBytes',
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechGrammarRules',
    'Speech_Max_Word_Length', 'DISPID_SpeechFileStream',
    'SpeechRecognizerState', 'SPRECOCONTEXTSTATUS',
    'SPEI_PHRASE_START', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SOTDataKey', 'DISPID_SPRulesCount', 'WAVEFORMATEX',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechPhraseInfoBuilder',
    'Speech_StreamPos_RealTime', 'SDTRule',
    'DISPID_SRRTOffsetFromStart', 'SPFM_NUM_MODES',
    'DISPID_SABIBufferSize', 'DISPID_SVEPhoneme',
    'SpeechPropertyComplexResponseSpeed', 'SPWF_SRENGINE',
    'DISPID_SABIEventBias', 'DISPID_SPISaveToMemory',
    'ISpeechPhraseRules', 'ISpeechRecognizer', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVWaitUntilDone', 'SPFM_OPEN_READWRITE',
    'SPFM_CREATE_ALWAYS', 'SPCT_DICTATION',
    'DISPID_SRGIsPronounceable', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRRAudio', 'SITooSlow', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SBSSeek', 'SAFT12kHz8BitMono', 'SPRS_ACTIVE',
    'DISPID_SRSSupportedLanguages', '_RemotableHandle',
    'DISPID_SLPPartOfSpeech', 'DISPID_SLWWord',
    'SGDSActiveUserDelimited', 'DISPID_SPRNumberOfElements',
    'SSFMCreateForWrite', 'SPFM_OPEN_READONLY', 'DISPID_SRCPause',
    'SP_VISEME_18', 'SAFT11kHz8BitMono', 'DISPID_SGRsCommit',
    'DISPID_SpeechPhraseBuilder', 'SpeechPartOfSpeech',
    'SREAdaptation', 'DISPID_SRCResume', 'SPWORDPRONOUNCEABLE',
    'DISPID_SpeechObjectToken', 'SpeechEngineConfidence',
    'SAFT8kHz16BitStereo', 'SAFT48kHz8BitMono',
    'SpeechCategoryVoices', 'SDTAll', 'DISPID_SRCRecognizer',
    'SAFTADPCM_22kHzStereo', 'SECFIgnoreWidth',
    'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_6',
    'SpStreamFormatConverter', 'SpeechWordPronounceable',
    'SSSPTRelativeToStart', 'SPEI_RESERVED1', 'ISpSerializeState',
    'DISPID_SGRSTText', 'SVF_Emphasis', 'DISPID_SDKSetBinaryValue',
    'SpNullPhoneConverter', 'SPSModifier',
    ...
    'SAFTGSM610_22kHzMono', 'DISPID_SPRText', 'SVP_9',
    'SREFalseRecognition', 'DISPID_SRCESoundEnd',
    'DISPID_SOTs_NewEnum', 'eLEXTYPE_PRIVATE7', 'SPSInterjection',
    'SPWT_PRONUNCIATION', 'DISPID_SPEAudioStreamOffset',
    'SGLexicalNoSpecialChars', 'DISPID_SDKGetlongValue', 'SPSVerb',
    'DISPID_SRGCmdLoadFromMemory', 'SDKLLocalMachine',
    'DISPID_SPEsItem', 'SpUnCompressedLexicon', 'SP_VISEME_13',
    'SVEVoiceChange', 'DISPID_SpeechPhoneConverter',
    'SpeechFormatType', 'SPCATEGORYTYPE', 'STCRemoteServer',
    'DISPID_SRRRecoContext', 'SASRun', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SGRAddResource', 'SPWORD',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechDataKeyLocation', 'SVEAllEvents', 'SAFT48kHz16BitStereo',
    'DISPID_SRRGetXMLResult', 'DISPID_SGRName',
    'SpeechTokenShellFolder', 'DISPID_SVAlertBoundary',
    'SVSFIsFilename', 'SP_VISEME_21', 'ISpeechLexicon',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED6', 'SPAO_RETAIN_AUDIO', 'DISPID_SRGId',
    'SAFTCCITT_uLaw_44kHzStereo', 'SREStreamStart',
    'DISPID_SLPPhoneIds', 'DISPID_SMSGetData', 'SpeechTokenKeyFiles',
    'SAFT32kHz8BitStereo', 'DISPID_SPRules_NewEnum', 'ISpeechDataKey',
    'SPAUDIOOPTIONS', 'ISpeechAudio',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpSharedRecognizer',
    'eLEXTYPE_PRIVATE9', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechAudioFormat', 'SVEEndInputStream',
    'SpeechRuleState', 'SPWORDPRONUNCIATION', 'SAFTADPCM_11kHzStereo',
    'SPSMF_UPS', 'SpeechLoadOption', 'SAFT32kHz8BitMono',
    'DISPID_SVSCurrentStreamNumber', 'SVP_20', 'SPRST_INACTIVE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPEActualConfidence', 'SPBO_NONE',
    'ISpeechResourceLoader', 'SVEWordBoundary',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SVEventInterests',
    'DISPID_SRCVoicePurgeEvent', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEVENTENUM', 'SLODynamic', 'DISPID_SPIStartTime',
    'SPPROPERTYINFO', 'tagSPTEXTSELECTIONINFO', 'SAFT22kHz8BitMono',
    'IEnumSpObjectTokens', 'SVSFParseSsml',
    'DISPID_SRGSetTextSelection', 'SGPronounciation',
    'SPPS_RESERVED3', 'DISPID_SFSClose', 'ISpNotifySink',
    'DISPID_SRRSetTextFeedback', 'SECFIgnoreCase',
    'DISPID_SOTGetStorageFileName', 'SVSFUnusedFlags', 'SVP_2',
    'SPEI_END_INPUT_STREAM', 'DISPID_SVSInputWordPosition',
    'DISPID_SPPChildren', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRDisplayUI', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_PRIVATE15', 'SPEI_START_INPUT_STREAM', 'SPVISEMES',
    'SpeechGrammarTagDictation', 'SPRECOGNIZERSTATUS',
    'SpObjectToken', 'DISPID_SPEAudioTimeOffset', 'ISpAudio',
    'SRSActiveAlways', 'DISPID_SRCreateRecoContext',
    'SAFT11kHz16BitStereo', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRCBookmark', 'ISpeechLexiconWord',
    'DISPID_SPRuleConfidence', 'DISPID_SGRsAdd',
    'DISPID_SGRInitialState', 'SGDSInactive', 'SPPS_RESERVED4',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRRPhraseInfo',
    'ISpeechObjectTokens', 'SP_VISEME_12', 'SPPHRASEELEMENT',
    'DISPID_SOTDisplayUI', 'DISPID_SRRecognizer', 'SGDisplay',
    'IInternetSecurityMgrSite', 'ISpStream',
    'DISPID_SpeechVoiceEvent', 'DISPID_SBSRead',
    'DISPID_SRCRequestedUIType', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechDataKey', 'ISpVoice', 'DISPID_SRRTLength',
    'ISpeechPhraseReplacements', 'SDTReplacement',
    'DISPID_SVGetVoices', 'SP_VISEME_8', 'DISPID_SVSRunningState',
    'SWTAdded', 'DISPID_SPEPronunciation', 'SVP_14',
    'DISPID_SPRDisplayAttributes', 'SpNotifyTranslator',
    'ISpeechRecoContext', 'SpeechGrammarState', 'SSFMOpenReadWrite',
    'SpeechStreamFileMode', 'SP_VISEME_0', 'SRTAutopause', 'SINoise',
    'STSF_FlagCreate', 'DISPID_SRCEFalseRecognition',
    'SPXRO_Alternates_SML', 'DISPID_SRGReset', 'SVEStartInputStream',
    'SPGS_DISABLED', 'SAFT24kHz16BitMono', 'DISPID_SPAs_NewEnum',
    'DISPID_SLPs_NewEnum', 'SpeechRegistryUserRoot',
    'SDKLCurrentUser', 'SPPS_NotOverriden', 'DISPID_SDKEnumKeys',
    'DISPID_SMSALineId', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SLPSymbolic', 'DISPID_SOTCSetId', 'SREStreamEnd',
    'DISPID_SPPId', 'ISpObjectTokenCategory', 'SpPhoneConverter',
    'ISpeechXMLRecoResult', '_ISpeechVoiceEvents', 'SPEI_MAX_TTS',
    'DISPID_SVPriority', 'ISpeechAudioBufferInfo',
    'DISPID_SRIsShared', 'SAFTDefault', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_SOUND_END', 'SPPHRASEPROPERTY', 'ISpeechGrammarRuleState',
    'SVEAudioLevel', 'SAFT24kHz8BitMono', 'SPINTERFERENCE_NONE',
    'DISPID_SLAddPronunciation', 'eLEXTYPE_RESERVED7',
    'DISPID_SPIProperties', 'SBONone', 'DISPID_SVSLastBookmark',
    'eLEXTYPE_RESERVED4', 'SDKLCurrentConfig',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRCState', 'DISPID_SOTsItem',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpDataKey',
    'DISPID_SOTSetId', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SABufferInfo', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVEBookmark', 'SpShortcut', 'SRTStandard',
    'SPEI_HYPOTHESIS', 'ISpeechAudioFormat', 'SPINTERFERENCE_TOOLOUD',
    'SpLexicon', 'SAFT48kHz16BitMono', 'DISPID_SOTCId',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'IStream', 'SP_VISEME_11',
    'SPRST_ACTIVE_ALWAYS', 'ISpeechLexiconWords',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechRecoContext',
    'SVP_15', 'DISPID_SPCPhoneToId', 'ISpMMSysAudio',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SpeechPhraseElements',
    'SPRS_ACTIVE_USER_DELIMITED', 'SSFMOpenForRead',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechLexicon', 'DISPID_SOTIsUISupported', 'SRAImport',
    'SASClosed', 'tagSPPROPERTYINFO', 'ISpeechPhoneConverter',
    'DISPID_SPPName', 'DISPID_SRGRecoContext',
    'ISpeechPhraseProperty', 'DISPID_SpeechPhraseRules',
    'SGRSTTWildcard', 'DISPID_SPERetainedSizeBytes',
    'SAFTADPCM_8kHzStereo', 'SPPS_LMA', 'SPRULESTATE',
    'DISPID_SpeechLexiconWords', 'DISPID_SPIRetainedSizeBytes',
    'SPPS_Unknown', 'DISPID_SPCLangId', 'DISPID_SpeechLexiconProns',
    'SRSInactive', 'DISPID_SLPLangId', 'DISPID_SASetState',
    'DISPID_SVRate', 'SPWAVEFORMATTYPE', 'DISPID_SRStatus',
    'DISPID_SPRuleNumberOfElements', 'SpeechCategoryAudioIn',
    'eLEXTYPE_PRIVATE4', 'SPDKL_LocalMachine', 'ISpEventSource',
    'DISPIDSPTSI_ActiveOffset', 'SpAudioFormat', 'SPVOICESTATUS',
    'DISPID_SRGetPropertyString', 'SpeechRunState',
    'SPSHT_NotOverriden', 'ISpeechPhraseInfo', 'SVP_17',
    'DISPID_SGRSTRule', 'ISpeechPhraseReplacement',
    'eLEXTYPE_PRIVATE5', 'DISPID_SVVoice', 'SASStop',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRGDictationUnload',
    'DISPID_SPRsCount', 'SpeechGrammarTagWildcard',
    'eLEXTYPE_PRIVATE18', 'DISPID_SGRsCount', 'SpInProcRecoContext',
    'SVP_10', 'SVF_None', 'IInternetSecurityManager',
    'DISPID_SPERequiredConfidence', 'SREPrivate',
    'Speech_Max_Pron_Length', 'DISPID_SLWPronunciations',
    'IEnumString', 'SDTAudio', 'SPEI_END_SR_STREAM',
    'DISPID_SPIEngineId', 'DISPID_SREmulateRecognition',
    'STSF_LocalAppData', 'SSTTDictation', 'DISPIDSPTSI',
    'DISPID_SRGSetWordSequenceData', 'SAFT11kHz16BitMono',
    'DISPID_SPILanguageId', 'SDA_Consume_Leading_Spaces',
    'SPCONTEXTSTATE', 'SPINTERFERENCE_TOOSLOW', 'SRCS_Enabled',
    'DISPID_SpeechGrammarRule', 'DISPID_SLWsItem',
    'ISpNotifyTranslator', 'SpObjectTokenCategory', 'SVSFIsXML',
    'SRTSMLTimeout', 'SPAUDIOSTATE', 'SVSFDefault',
    'SAFT16kHz16BitMono', 'SpeechCategoryRecoProfiles',
    'SPTEXTSELECTIONINFO', 'DISPID_SRCEEndStream',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPRsItem',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFT44kHz8BitStereo',
    'DISPID_SRRTimes', 'DISPID_SRSNumberOfActiveRules',
    'SPEI_TTS_BOOKMARK', 'SAFT11kHz8BitStereo', 'SRAExport',
    'SDTProperty', 'SAFT44kHz16BitStereo', 'SVP_1',
    'DISPID_SMSSetData', 'DISPID_SOTsCount', 'SAFT24kHz16BitStereo',
    'SP_VISEME_16', 'ISpRecoResult', 'DISPID_SPEEngineConfidence',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFVoiceMask', 'SPWF_INPUT',
    'SPRST_NUM_STATES', 'SpVoice', 'DISPID_SLRemovePronunciation',
    'DISPID_SAFGetWaveFormatEx', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPCIdToPhone', 'DISPID_SASState', 'SRTEmulated',
    'SAFT24kHz8BitStereo', 'DISPID_SVSVisemeId',
    'SpeechTokenKeyAttributes', 'SpeechVoicePriority',
    'DISPID_SGRsDynamic', 'SpMMAudioEnum', 'ISpeechPhraseElement',
    'DISPID_SPRuleFirstElement', 'SVP_6', 'SpeechRecognitionType',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_APP', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPRuleChildren', 'SpeechBookmarkOptions', 'SP_VISEME_10',
    'SpeechAudioState', 'DISPID_SOTCDefault',
    'DISPID_SOTGetAttribute', 'DISPID_SVEStreamEnd',
    'SPEI_REQUEST_UI', 'SRAInterpreter', 'SP_VISEME_4',
    'SpeechAddRemoveWord', 'SAFT22kHz16BitStereo', 'SECFDefault',
    'SDA_One_Trailing_Space', 'DISPID_SRCEPhraseStart',
    'SPEI_UNDEFINED', 'DISPID_SVSPhonemeId', 'SPSHT_Unknown',
    'SGSDisabled', 'DISPID_SRGetFormat', 'DISPID_SRCERequestUI',
    'eLEXTYPE_RESERVED10', 'SPLEXICONTYPE',
    'DISPID_SDKGetStringValue', 'DISPID_SVSpeakStream',
    'SPEI_RESERVED2', 'SRSActive', 'SRADynamic',
    'DISPID_SPIAudioStreamPosition', 'SPINTERFERENCE',
    'SVSFPurgeBeforeSpeak', 'SDA_No_Trailing_Space', 'SPPS_Verb',
    'SPWORDTYPE', 'SP_VISEME_19', 'SPPS_RESERVED1', 'SpMMAudioIn',
    'DISPID_SOTCreateInstance', 'SWPUnknownWordUnpronounceable',
    'ISpStreamFormatConverter', 'DISPID_SRGState', 'SPWORDLIST',
    'ISpRecognizer3', 'DISPID_SRGetPropertyNumber',
    'DISPID_SADefaultFormat', 'SPBO_PAUSE', 'SPAUDIOSTATUS',
    'SPEI_START_SR_STREAM', 'SPSHT_OTHER',
    'DISPID_SRSCurrentStreamNumber', 'SAFTADPCM_11kHzMono',
    'SPPHRASEREPLACEMENT', 'DISPID_SRGDictationSetState',
    'SAFTADPCM_44kHzStereo', 'SPEI_VOICE_CHANGE', 'SPPS_Noun',
    'ISpObjectToken', 'DISPID_SPEsCount', 'SpMMAudioOut',
    'DISPID_SGRSTsCount', 'SDTDisplayText',
    'DISPID_SPPNumberOfElements', 'SPSNoun', 'DISPID_SVResume',
    'DISPID_SRGCmdLoadFromObject', 'SpeechRecoContextState',
    'SPSHORTCUTPAIRLIST', 'DISPID_SAStatus', 'DISPID_SRCVoice',
    'DISPID_SAFType', 'SVSFNLPSpeakPunc', 'SpWaveFormatEx',
    'SSSPTRelativeToCurrentPosition', 'SpeechRecoEvents',
    'SpPhoneticAlphabetConverter', 'SAFTGSM610_11kHzMono', 'SLTUser',
    'SPPS_Interjection', 'DISPID_SPPEngineConfidence',
    'SPEI_INTERFERENCE', 'SVP_16', 'DISPID_SPIReplacements',
    'DISPID_SPPConfidence', 'SpeechVoiceEvents',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVSkip', 'ISpeechRecoResult',
    'SpeechCategoryAudioOut', 'DISPID_SOTGetDescription',
    'eLEXTYPE_PRIVATE17', 'ISpeechWaveFormatEx', 'SPEVENT',
    'ISpeechObjectTokenCategory', 'DISPID_SOTMatchesAttributes',
    'SAFTGSM610_8kHzMono', 'DISPID_SWFESamplesPerSec',
    'ISpeechMMSysAudio', 'SPPS_Noncontent', 'SREPropertyStringChange',
    'DISPID_SVEWord', 'ISpPhraseAlt', 'SpTextSelectionInformation',
    'SGSEnabled', 'SAFT12kHz8BitStereo', 'SVEBookmark', 'SPSFunction',
    'SSSPTRelativeToEnd', 'DISPID_SMSADeviceId',
    'SpeechVoiceCategoryTTSRate', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpStreamFormat', 'SWPKnownWordPronounceable',
    'SpeechLexiconType', 'SpeechVisemeFeature', 'SRATopLevel',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRIsUISupported',
    'SPEI_SR_AUDIO_LEVEL', 'SFTInput', 'DISPID_SVIsUISupported',
    'SPEI_PROPERTY_STRING_CHANGE', 'SRTReSent', 'SAFT12kHz16BitMono',
    'ISpeechPhraseAlternate', 'SWTDeleted', 'DISPID_SGRAddState',
    'SRTExtendableParse', 'STCAll', 'SPRULE', 'SPEI_SOUND_START',
    'SPCT_SUB_DICTATION', 'SPEI_VISEME', 'SP_VISEME_3',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SVAudioOutput',
    'SPEI_ADAPTATION', 'SRERecognition', 'SREStateChange',
    'DISPID_SPIGrammarId', 'DISPID_SPACommit', 'SVPOver',
    'ISpPhoneticAlphabetConverter', 'DISPID_SOTCategory',
    'DISPID_SAEventHandle', 'SRSEDone', 'SP_VISEME_5', 'SPEI_MIN_TTS',
    'SPGRAMMARWORDTYPE', 'SPBOOKMARKOPTIONS',
    'SpeechDisplayAttributes', 'SDKLDefaultLocation', 'SVF_Stressed',
    'SPDATAKEYLOCATION', 'SVP_12', 'DISPID_SRAudioInput',
    'DISPID_SASFreeBufferSpace',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPINTERFERENCE_NOISE',
    'DISPID_SRGCommit', 'SVP_11', 'SREBookmark', 'SPSTREAMFORMATTYPE',
    ...
    'ISpeechObjectToken', 'SAFT22kHz8BitStereo', 'SECFNoSpecialChars',
    '_ISpeechRecoContextEvents', 'SVESentenceBoundary',
    'DISPID_SRSClsidEngine', 'SpeechAudioProperties',
    'SpeechDictationTopicSpelling', 'DISPID_SVStatus',
    'SPPS_Function', 'SPEI_SR_PRIVATE', 'SPPS_SuppressWord',
    'SGRSTTTextBuffer', 'SPAR_Unknown', 'DISPID_SVDisplayUI',
    'STCLocalServer', 'SpeechCategoryRecognizers',
    ...
    'SAFT8kHz8BitMono', 'DISPID_SWFEBlockAlign', 'SPEI_MAX_SR',
    'SPPHRASE', 'SAFT22kHz16BitMono', 'SAFT32kHz16BitMono',
    ...
    'DISPID_SRState', 'ISequentialStream', 'SVP_19',
    'DISPID_SRCEAdaptation', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SDKCreateKey', 'DISPID_SPIGetText',
    'DISPID_SPIEnginePrivateData',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechPhraseAlternates', 'SPCT_SLEEP',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPPValue', 'LONG_PTR',
    'SVP_0', 'SPAS_PAUSE', 'DISPID_SPEDisplayText', 'DISPID_SVPause',
    ...
    'DISPID_SLGetGenerationChange', 'DISPID_SPRuleParent', 'SVP_8',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVEAudioLevel',
    'SpInprocRecognizer', 'ISpXMLRecoResult',
    'DISPID_SRCRetainedAudioFormat', 'SVP_7', 'DISPID_SPARecoResult',
    ...
    'DISPID_SVAudioOutputStream', 'SPAS_CLOSED',
    'DISPID_SVSInputSentenceLength', 'SVP_18',
    'DISPID_SVEEnginePrivate', 'SAFT48kHz8BitStereo', 'SREHypothesis',
    'DISPID_SVGetAudioInputs', 'ISpeechGrammarRule',
    'DISPID_SRRSaveToMemory', 'ISpGrammarBuilder', 'SREPhraseStart',
    'SpeechRecoProfileProperties', 'ISpeechPhraseProperties',
    'SP_VISEME_2', 'DISPID_SMSAMMHandle', 'DISPID_SAFGuid',
    'DISPID_SVEVoiceChange', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SDKDeleteValue', 'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE6',
    'SVP_4', 'SpeechGrammarWordType', 'SPFILEMODE', 'SPEI_PHONEME',
    'ISpeechRecognizerStatus', 'SpeechVisemeType', 'SVSFParseSapi',
    'SGDSActive', 'SPPARTOFSPEECH', 'DISPID_SPPsItem',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCAudioInInterferenceStatus', 'SECFIgnoreKanaType',
    ...
    'SpStream', 'SDTAlternates', 'ISpRecognizer', 'SPCT_SUB_COMMAND',
    'SPCT_COMMAND', 'DISPID_SLGenerationId', 'SAFT32kHz16BitStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpSharedRecoContext',
    'DISPID_SDKDeleteKey', 'SpeechTokenIdUserLexicon',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVP_21', 'DISPID_SpeechObjectTokens',
    'SVSFParseAutodetect', 'SpeechTokenContext', 'ISpRecoContext2',
    'SPLOADOPTIONS', 'SpeechRetainedAudioOptions',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechObjectTokenCategory',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SVPNormal',
    'DISPID_SRCEBookmark', 'DISPID_SRGRules',
    ...
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SGRSAddWordTransition',
    'DISPID_SVVolume', 'DISPID_SRCEInterference',
    'DISPID_SWFEChannels', 'SPFM_CREATE', 'SRERequestUI',
    'DISPID_SPAsCount', 'DISPID_SPRuleId',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eWORDTYPE_ADDED',
    'DISPID_SLWType', 'eLEXTYPE_VENDORLEXICON', 'SREAudioLevel',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechPhraseProperties',
    'STSF_CommonAppData', 'SP_VISEME_9',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPPHRASERULE',
    'DISPID_SRCEHypothesis', 'SINoSignal', 'SPEI_RECO_OTHER_CONTEXT',
    ...
    'SpPhraseInfoBuilder', 'DISPID_SRRAudioFormat', 'SLTApp',
    'SP_VISEME_14', 'SP_VISEME_17', 'DISPID_SDKSetLongValue',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechAudioStatus',
    'DISPID_SPAsItem', 'SAFT8kHz8BitStereo', 'DISPID_SRRAlternates',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRCEventInterests',
    'DISPID_SLPsCount', 'SpeechPropertyHighConfidenceThreshold',
    'SPADAPTATIONRELEVANCE', 'DISPID_SVEViseme', 'SPGS_EXCLUSIVE',
    'DISPID_SGRClear', 'ISpeechLexiconPronunciation',
    'DISPID_SRGetRecognizers', 'DISPID_SGRSTPropertyName',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPIAudioSizeTime', 'UINT_PTR',
    'DISPID_SWFEAvgBytesPerSec', 'SPSLMA', 'SDA_Two_Trailing_Spaces',
    'ISpeechGrammarRules', 'ISpLexicon', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPRFirstElement', 'SAFT44kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechPhraseElements',
    'SpeechPropertyResponseSpeed', 'SpeechCategoryPhoneConverters',
    'SPAS_STOP', 'SPEI_SR_BOOKMARK', 'SGRSTTWord',
    'DISPID_SpeechRecoResult', 'SPSERIALIZEDPHRASE',
    'SPBO_TIME_UNITS', 'DISPID_SRCSetAdaptationData',
    'DISPID_SVEStreamStart', 'ISpObjectWithToken', 'SPEI_RESERVED5',
    'SPSNotOverriden', 'SPAUDIOBUFFERINFO', 'SpeechAudioFormatType',
    'ISpeechRecoResult2', 'DISPID_SGRSTNextState', 'SSTTWildcard',
    'SPVPRI_NORMAL', 'DISPID_SRCCreateGrammar', 'ISpeechVoice',
    'SRERecoOtherContext', 'SPDKL_DefaultLocation', 'SPSUnknown',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechWaveFormatEx',
    'SITooLoud', 'ISpeechLexiconPronunciations', 'SFTSREngine',
    'DISPID_SPPsCount', 'SVEPrivate', 'Speech_StreamPos_Asap',
    'DISPID_SpeechRecoContextEvents', 'SRAORetainAudio',
    'SPBINARYGRAMMAR', 'SPRECOSTATE', 'SPDKL_CurrentConfig',
    'ISpShortcut', 'SAFTNonStandardFormat', 'SITooQuiet',
    'SpeechTokenValueCLSID', 'SPEI_RESERVED3', 'DISPID_SLWsCount',
    'DISPID_SWFEFormatTag', 'DISPID_SRCESoundStart',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_SENTENCE_BOUNDARY', 'SPAR_Low', 'SPEI_MIN_SR',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechPhraseAlternate',
    '__MIDL_IWinTypes_0009', 'DISPID_SGRSTsItem', 'SPLO_STATIC',
    'SAFTADPCM_44kHzMono', 'DISPID_SRRSpeakAudio', 'SGLexical'
]
